                ...
                <form class="formulario-container">
                    ...
                    <ul class="nav nav-tabs nav-tabs-dark mb-4" id="abasConfigArtista" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="perfil-tab" data-bs-toggle="tab" data-bs-target="#tab-perfil" type="button" role="tab" aria-controls="tab-perfil" aria-selected="true">Perfil e Estilos</button>
                        </li>
                        <li class="nav-item" role="presentation">
